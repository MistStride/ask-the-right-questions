...
> 最后更新：2026-09-07（难度梯度 2.0 ch02 试点；新增「知识教学层」①章节知识卡 13 章已上线）
...
**A. 内容/玩法（用户视角最敏感）**
- [x] **难度梯度 2.0 · ch02 试点（2026-09-07）**：论证透视镜三关升级为 D1/D2/D3 阶梯（L1 127字/3+2节点 → L2 169字/4+2节点含半迷惑歧义词 → L3 357字/3+3节点含「结论伪装」陷阱）。验证脚本见第 8 节。其余引擎（scale/courtroom/defusal 最薄）待铺开。
...
**铺开顺序建议**：xray 其余章（ch03/05/11）→ 最薄的 scale（6 关，需加交互）→ defusal（加文本+弱化提示）→ courtroom（干扰问题去卡通化）→ tamer（boss 模式去固定「追问」）。
